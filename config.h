...
static const char colors[NUMCOLORS][ColLast][9] = {
  ...
  { "#282a2e", "#fb3737", "#1d1f21" }, // 6 = red on black
  { "#282a2e", "#5ab762", "#1d1f21" }, // 7 = green on black
  { "#282a2e", "#fb700f", "#1d1f21" }, // 8 = orange on black
  { "#282a2e", "#f0c674", "#282a2e" }, // 9 = yellow on darkgrey
  { "#282a2e", "#81a2be", "#282a2e" }, // A = blue on darkgrey
  { "#282a2e", "#5ab762", "#282a2e" }, // B = green on darkgrey
